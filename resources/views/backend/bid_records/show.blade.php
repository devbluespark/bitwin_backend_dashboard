                    ...
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header">
                                <strong class="card-title">Bid Details</strong>
                            </div>
                            <div class="row">
                                <div class="col-lg-10 ml-5">
                                    <div class="card row">
                                        ...
                                        <div class=" card-block col-6 mr-4 ">
                                            <div class="form-group"><label for="company"  class=" form-control-label">Bid ID</label>
                                                <input type="text" id="company" value="{{$bid_records->id}}" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group"><label for="street" class=" form-control-label">Product Price</label>
                                             ...
                                             <input type="text" id="street" value="{{$user_records->user_fname}} {{ $user_records->user_lname }}" class="form-control">
                                         </div> 
                                           ...
                                           <div class="row form-group">                                                       
                                               <div class="row">
                                                   <div class="text-center col-12">
                                                    ...
                                                    <?php 
                                                    if ($product_details->product_img_1 === NULL) {
                                                        $product_details->product_img_1 = "product_default.jpg";
                                                    }
                                  
                                                  ?>

                                                       <img src="{{ asset('storage/images/products').'/'.$product_details->product_img_1 }}" width="500px" height="500px" class="rounded" alt="...">
                                                   </div>
                                               </div>
                                           </div>
                                       </div>
