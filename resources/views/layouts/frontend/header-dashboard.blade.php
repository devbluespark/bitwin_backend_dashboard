    ...
    <!-- Custom fonts -->
    <link rel="stylesheet" href="{{asset('assets/frontend/assets/css/bs-fonts.css')}}">
    <!-- Common styles -->
    <link rel="stylesheet" href="{{asset('assets/frontend/assets/css/style.css')}}">

    <!-- Dashboard styles -->
    <link rel="stylesheet" href="{{asset('assets/frontend/assets/css/dashboard.css')}}">

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>


    <link rel="stylesheet" href="{{ asset('assets/frontend/asset/css/custom.css') }}" >
